package com.praveen.rentcloud.rentui.controller;
...
import com.praveen.rentcloud.rentui.config.AccessToken;
...
public class UIController extends WebSecurityConfigurerAdapter{
    ...
    public String loadCustomers(Model model){
		...
		try {
			...
			ResponseEntity<String> responseEntity = ResponseEntity.status(e.getRawStatusCode()).body(e.getResponseBodyAsString());
